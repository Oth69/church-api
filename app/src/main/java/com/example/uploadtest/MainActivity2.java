...
import com.example.uploadtest.model.FileinModel;
import com.example.uploadtest.model.RetrievePDFActivity;
...
public class MainActivity2 extends AppCompatActivity {
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(MainActivity2.this, "File Uploaded Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void retrievePDFs(View view) {
        ...
        startActivity(new Intent(MainActivity2.this, RetrievePDFActivity.class));
    }
